...
export default function AboutSection() {
  return (
    <section
      id="about"
      className="flex scroll-mt-32 justify-center border-b-2 border-black bg-[#FFD600] px-4 py-24 transition-colors duration-300 dark:border-white/10 dark:bg-black"
    >
      <div className="w-full max-w-[1200px]">
        <div className="relative flex flex-col items-center gap-16 overflow-hidden rounded-[3rem] border-4 border-black bg-white p-10 shadow-[10px_10px_0px_0px_rgba(0,0,0,1)] transition-all md:p-16 lg:flex-row dark:border dark:border-white/10 dark:bg-[#111] dark:shadow-none">
          ...
          <div className="relative z-10 flex-1">
            <h3 className="mb-8 text-4xl leading-tight font-black md:text-5xl">
              엔지니어의{' '}
              <span className="bg-black px-3 py-1 text-white transition-colors dark:bg-transparent dark:px-0 dark:text-[#FFD600]">
                머리
              </span>
              와<br />
              디자이너의 <span className="italic">가슴</span>으로
            </h3>
            <p className="mb-10 text-xl leading-relaxed font-bold text-gray-800 transition-colors dark:font-medium dark:text-gray-400">
          ...
          <div className="relative z-10 flex w-full justify-center lg:w-1/3">
            <Link href="/profile" className="group relative block h-64 w-64 cursor-pointer">
              ...
              <div className="relative h-full w-full overflow-hidden rounded-full border-2 border-black bg-gray-200 transition-colors dark:border-white/20 dark:bg-gray-800">
              ...
              <div className="absolute -right-4 -bottom-4 rotate-6 rounded-lg border-2 border-black bg-white px-4 py-2 font-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all group-hover:rotate-12 dark:border dark:border-white/20 dark:bg-[#111] dark:text-white dark:shadow-lg">
