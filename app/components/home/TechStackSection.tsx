...
export default function TechStackSection() {
  return (
    <div className="border-b-2 border-black bg-white py-12 transition-colors duration-300 dark:border-t-0 dark:border-b dark:border-white/10 dark:bg-[#0a0a0a]">
      <div className="mx-auto max-w-[1200px] px-4">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          {Object.entries(TECH_STACK).map(([category, items]) => (
            <div key={category} className="flex flex-col gap-4">
              <h3 className="border-b-2 border-black pb-2 text-xl font-black text-black transition-colors dark:border-white/10 dark:text-gray-300">
                {category}
              </h3>
