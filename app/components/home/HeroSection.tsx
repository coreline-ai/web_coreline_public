      ...
      <div className="relative z-10 flex w-full max-w-[1200px] flex-col items-center gap-20 lg:flex-row">
        <div className="flex flex-1 flex-col gap-8">
          <div className="inline-flex w-fit items-center gap-2 rounded-full border-2 border-black bg-white px-4 py-1.5 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] transition-all dark:border dark:border-white/10 dark:bg-white/5 dark:shadow-none bw:border-black bw:bg-white bw:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
            ...
            <span className="text-xs font-bold tracking-wider text-black uppercase dark:text-gray-300 bw:text-black">
              프로젝트 접수 중
            </span>
          </div>

          <h1 className="text-[8vw] leading-tight font-black tracking-tight break-keep transition-colors sm:text-5xl md:text-7xl">
            <span className="whitespace-nowrap">
              미래를 코딩하는{' '}
              <span className="dark:bg-gradient-to-r dark:from-[#FFD600] dark:to-yellow-200 dark:bg-clip-text dark:text-transparent bw:text-black">
                AI
              </span>
            </span>
            <br />
            <span className="whitespace-nowrap">
              <span className="relative inline-block">
                <span className="inline-block bg-[#FFD600] px-2 text-black dark:text-black bw:text-black">
                  엔지니어링
                </span>
              </span>{' '}
              스튜디오
          ...
          <p className="max-w-lg border-l-4 border-black pl-6 text-xl leading-relaxed font-medium text-gray-700 transition-all dark:border-l-2 dark:border-[#FFD600] dark:text-gray-400 bw:border-black bw:text-gray-700">
        ...
        <div className="relative w-full max-w-[500px] flex-1 lg:translate-y-10">
          ...
          <div className="group relative aspect-square overflow-hidden rounded-[2rem] border-2 border-black bg-white shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-all duration-300 dark:border dark:border-white/20 dark:bg-[#111] dark:shadow-2xl dark:shadow-blue-500/10 bw:border-black bw:bg-white bw:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
            ...
            <div className="relative flex h-full items-center justify-center overflow-hidden bg-gray-50 dark:bg-black/50 bw:bg-gray-50">
              ...
              <div className="absolute inset-0 z-0 flex items-center justify-center transition-opacity duration-500 group-hover:opacity-0">
                <div className="pointer-events-none absolute inset-0 grid grid-cols-[repeat(20,minmax(0,1fr))] grid-rows-[repeat(20,minmax(0,1fr))] opacity-25">
                  {Array.from({ length: 400 }).map((_, i) => (
                    <div
                      key={i}
                      className="border-[0.5px] border-black/10 dark:border-white/10 bw:border-black/10"
                    ></div>
                  ))}
                </div>
                <span
                  className="material-symbols-outlined notranslate relative z-10 animate-pulse text-black/20 dark:text-white/40 bw:text-black/20"
              ...
              <div className="absolute inset-0 z-20 bg-gradient-to-t from-black/5 via-transparent to-transparent dark:from-black/40 bw:hidden"></div>
            </div>

            <div className="absolute right-6 bottom-6 left-6 z-30 rounded-xl border-2 border-black bg-white p-4 shadow-[4px_4px_0px_0px_rgba(0,0,0,0.1)] transition-all dark:border dark:border-white/10 dark:bg-[#222]/90 dark:shadow-none dark:backdrop-blur-md bw:border-black bw:bg-white/80 bw:shadow-[4px_4px_0px_0px_rgba(0,0,0,0.1)]">
              <div className="flex items-center gap-4">
                <span
                  className="material-symbols-outlined notranslate text-black dark:text-[#FFD600] bw:text-black"
                  aria-hidden="true"
                >
                  smart_toy
                </span>
                <div className="flex-1">
                  ...
                  <div className="h-2 w-full overflow-hidden rounded-full border border-black/10 bg-gray-200 dark:border-transparent dark:bg-gray-700 bw:border-black/10 bw:bg-gray-200">
                    <div className="h-full w-[75%] rounded-full bg-black dark:bg-[#FFD600] bw:bg-black"></div>
                  </div>
                </div>
              </div>
            </div>
