...
export default function Error({
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-white p-6 text-center text-black dark:bg-black dark:text-white">
      ...
      <button
        onClick={reset}
        className="rounded-lg border-2 border-transparent bg-black px-8 py-3 font-bold text-white transition-all hover:opacity-80 active:scale-95 dark:bg-white dark:text-black"
      >
        Try Again
      </button>
    </div>
