          ...
          <div className="relative mb-16 overflow-hidden rounded-[2rem] border border-black bg-white shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-all dark:border-white/20 dark:bg-[#1a1a1a] dark:shadow-none">
            ...
            <div className="relative z-10 p-8 md:p-12">
              <div className="mb-6 flex flex-wrap items-center gap-4">
                <span className="rounded-lg border-2 border-black bg-[#FFD600] px-4 py-1.5 text-xs font-black tracking-widest text-black uppercase shadow-[2px_2px_0px_0px_black] dark:border-transparent dark:shadow-none">
                  WEB APPLICATION
                </span>
                {project.version && (
                  <span className="rounded-lg border-2 border-black bg-white px-3 py-1.5 font-mono text-xs font-bold dark:border-white/20 dark:bg-black dark:text-gray-300">
                    {project.version}
                  </span>
                )}
              </div>
              ...
              <div className="flex flex-col justify-between gap-8 md:flex-row md:items-start">
                <div className="flex-1">
                  ...
                  <p className="max-w-2xl text-lg leading-relaxed font-medium text-gray-600 md:text-xl dark:text-gray-300">
                    {project.description}
                  </p>
                </div>
                {project.repoUrl && (
          ...
          {project.techStack && (
            <div className="mb-20">
              <h2 className="mb-8 flex items-center gap-4 text-xl font-black tracking-widest uppercase">
                TECHNICAL STACK
                <div className="h-1 flex-1 rounded-full bg-black dark:bg-white/20"></div>
              </h2>
          ...
          <div className="rounded-[2.5rem] border border-black bg-white p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] md:p-12 dark:border-white/20 dark:bg-[#1a1a1a] dark:shadow-none">
            <div className="grid grid-cols-1 gap-16 lg:grid-cols-2">
              ...
              <div>
                ...
                <p className="mb-12 text-lg leading-relaxed font-medium text-gray-600 dark:text-gray-300">
              ...
              {/* Right Column */}
              <div>
                <h2 className="mb-8 text-xl font-black tracking-wide text-gray-400 uppercase dark:text-gray-500">
                  Core Features
                </h2>
                ...
                <div className="mt-12 border-t border-dashed border-gray-200 pt-8 dark:border-white/10">
                  <div className="flex items-center justify-between rounded-xl border-2 border-gray-200 bg-gray-50 p-4 font-mono text-xs dark:border-white/10 dark:bg-black dark:text-gray-400">
                    <span>
                      Status:{' '}
                      <span className="ml-2 rounded bg-green-100 px-2 py-0.5 font-bold text-green-600 dark:bg-green-900/30 dark:text-green-400">
                        Active Maintenance
                      </span>
                    </span>
                    <span>
                      License:{' '}
                      <span className="font-bold text-black dark:text-white">MIT License</span>
                    </span>
                  </div>
                </div>
              </div>
