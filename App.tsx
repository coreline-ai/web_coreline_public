  ...
  return (
    <div className={`${isDarkMode ? 'dark' : ''}`}>
      <div className="min-h-screen transition-colors duration-300 font-sans
          ...
          <div className="pointer-events-auto w-full max-w-[1200px] rounded-xl px-6 py-4 flex items-center justify-between transition-all duration-300
            ...
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 flex items-center justify-center rounded-lg transition-all duration-300
                ...
                dark:bg-[#FFD600] dark:text-black">
              ...
              <div className="relative aspect-square rounded-[2rem] overflow-hidden transition-all duration-300
                ...
                <div className="p-8 h-full flex items-center justify-center overflow-hidden relative
                  ...
                  <span className="material-symbols-outlined text-9xl animate-pulse
                    text-black/10
                    dark:text-white/50">code_blocks</span>
                </div>
        ...
        {/* Services Section */}
        <section id="services" className="py-24 px-4 flex justify-center transition-colors duration-300
              ...
              <div className="flex flex-col gap-4">
                ...
                <h2 className="text-4xl md:text-6xl font-black">
                  ...
                  <span className="transition-all
                    ...
                    dark:text-[#8B5CF6] dark:[text-shadow:none]">확실한 결과.</span>
                </h2>
              </div>
              ...
              {SERVICES.map((s) => (
                <div key={s.id} className="p-6 rounded-2xl transition-all group cursor-pointer
                  ...
                  <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-6 transition-all group-hover:scale-110
                    ...
                    dark:bg-gray-900 dark:border dark:border-white/10"
                    style={{ backgroundColor: !isDarkMode ? s.color : undefined }}>
                    <span className="material-symbols-outlined text-3xl
                      text-white
                      dark:text-white"
                      style={{ color: !isDarkMode ? '#fff' : (s.color === '#000000' ? '#fff' : s.color) }}>
                      {s.icon}
                    </span>
                  </div>
        ...
        {/* Portfolio Section */}
        <section id="projects" className="py-24 px-4 flex justify-center border-b-2 transition-colors duration-300
        ...
        {/* Process Section */}
        <section id="process" className="py-24 px-4 flex justify-center border-b-2 transition-colors duration-300
        ...
        {/* About Section */}
        <section id="about" className="py-24 px-4 flex justify-center border-b-2 transition-colors duration-300
        ...
        <footer className="py-24 px-4 flex justify-center border-t-2 transition-colors duration-300
          ...
          <div className="max-w-[1200px] w-full">
            ...
            <div className="pt-12 border-t-2 flex flex-col md:flex-row justify-between items-center gap-8 transition-colors
              ...
              <p className="text-sm font-bold text-gray-500 dark:text-gray-600">© 2024 Coreline Studio. All rights reserved.</p>
            </div>
          </div>
        </footer>
      </div>
